...
class PrivateHosptal extends StatefulWidget {
  const PrivateHosptal({super.key});

  @override
  State<PrivateHosptal> createState() => _PrivateHosptalState();
}

class _PrivateHosptalState extends State<PrivateHosptal> {
  @override
        ...
        child: Consumer<GetHospitalProvider>(builder: (context, value, child) {
          ...
          return GridView.builder(
            ...
            gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                ...
                crossAxisSpacing: 20,
                mainAxisSpacing: 20),
            itemCount: value.privatehospitalall.length,
            itemBuilder: (context, index) {
              var span1 = TextSpan(text: value.privatehospital[index].name);
              var tp1 = TextPainter(
                maxLines: 1,
              ...
              return InkWell(
                onTap: () {
                  context.read<GetHospitalProvider>().getClickedHospital(
                        index,
                        0,
                        value.privatehospitalall[index].name,
                                      ...
                                      SizedBox(
                                        width:
                                            MediaQuery.of(context).size.width *
                                                .2,
                                        child: Text(
                                          value.privatehospitalall[index].city,
