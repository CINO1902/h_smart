...
SpecializeDoctor specializeDoctorFromJson(String str) =>
    SpecializeDoctor.fromJson(json.decode(str));

String specializeDoctorToJson(SpecializeDoctor data) =>
...
class SpecializeDoctor {
  ...
  factory SpecializeDoctor.fromJson(Map<String, dynamic> json) =>
      SpecializeDoctor(
        status: json["status"],
